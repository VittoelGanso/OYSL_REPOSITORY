    ...
    public partial class Señor_Oscuro : Form
    {
        ...
        public string[] cartas_excusa =
     {
        ...
        public Señor_Oscuro()
        {
            ...
            int value = random.Next(0, cartas_excusa.Length);
            string carta1 = cartas_accion[value];
            value = random.Next(0, cartas_excusa.Length);
            string carta2 = cartas_accion[value];
            value = random.Next(0, cartas_excusa.Length);
            string carta3 = cartas_accion[value];
            Excusa1.ImageLocation = carta1 + ".png";
            Excusa2.ImageLocation = carta2 + ".png";
            Excusa3.ImageLocation = carta3 + ".png";

            value = random.Next(0, cartas_accion.Length);
