...
{
    public partial class Grafico_Juego : Form
    {
        ...
        private void jugar_Click(object sender, EventArgs e)
        {
            ...
            AccionBox.Visible = true;
            ExcusasBox.Visible = true;
            Jugador_izquierda.Visible = true;
            Jugador_derecha.Visible = true;
            MuestraReverso(AccionBox);
            MuestraReverso(ExcusasBox);
            MuestraReverso(Jugador_derecha);
            MuestraReverso(Jugador_izquierda);
        ...
        private void SeñorOscuro()
        {
            //Si el jugador ha escogido como personaje el señor oscuro el programa realiza la siguiente función
            //Hacemos visibles los distintos mazos de cartas que habrá en el juego
